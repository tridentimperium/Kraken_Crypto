...
# Fixed table name
TABLE_NAME = "dbo.Crypto_501_DEV_01_01_Kraken_Live_Data"
...
keep_hours = int(params.get("Kraken_Live_Data_HRs", 24))  # Default to 24 hours if missing
...
IF NOT EXISTS (SELECT * FROM INFORMATION_SCHEMA.TABLES 
               WHERE TABLE_SCHEMA = 'dbo' AND TABLE_NAME = 'Crypto_501_DEV_01_01_Kraken_Live_Data')
BEGIN
    CREATE TABLE {TABLE_NAME} (
        ...
        CONSTRAINT PK_Crypto_501_DEV_01_01_Kraken_Live_Data 
...
BEGIN
    ...
    IF NOT EXISTS (SELECT 1 FROM INFORMATION_SCHEMA.COLUMNS 
                   WHERE TABLE_SCHEMA = 'dbo' 
                     AND TABLE_NAME = 'Crypto_501_DEV_01_01_Kraken_Live_Data' 
...
def clean_old_data():
    if keep_hours <= 0:
        logger.info("Kraken_Live_Data_HRs <= 0 – skipping cleanup")
        return
