...
# TABLE NAMES
# ================================
SOURCE_TABLE = "dbo.Crypto_501_DEV_01_06_Entry_Exit_Order"
TARGET_TABLE = "dbo.Crypto_501_DEV_01_08_Portfolio_Balance"
...
IF NOT EXISTS (SELECT * FROM INFORMATION_SCHEMA.TABLES WHERE TABLE_SCHEMA = 'dbo' AND TABLE_NAME = 'Crypto_501_DEV_01_08_Portfolio_Balance')
BEGIN
...
BEGIN
    IF NOT EXISTS (
        ...
        WHERE TABLE_NAME = 'Crypto_501_DEV_01_08_Portfolio_Balance' 
