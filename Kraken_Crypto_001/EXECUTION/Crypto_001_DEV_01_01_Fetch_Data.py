...
# Fixed table name
TABLE_NAME = "dbo.Crypto_001_DEV_01_01_Fetch_Data"

# Parameters file
params_file = os.path.join(config_path, "ZZ_PARAMETERS", "Crypto_001_parameters.json")
...
if load_sql:
    sql_env_file = os.path.join(
        ...
        "Crypto_001_sqlserver_local.env" if sql_mode == "1" else "Crypto_001_sqlserver_remote.env"
    )
...
# CloudAPI .env
if load_api:
    api_env_file = os.path.join(config_path, "CLOUDAPI", "Crypto_001_cloudapi.env")
...
IF NOT EXISTS (SELECT * FROM INFORMATION_SCHEMA.TABLES 
               WHERE TABLE_SCHEMA = 'dbo' AND TABLE_NAME = 'Crypto_001_DEV_01_01_Fetch_Data')
BEGIN
    CREATE TABLE {TABLE_NAME} (
        ...
        CONSTRAINT PK_Crypto_001_Fetch_Data PRIMARY KEY (FetchRunID, DateTime, Symbol, Timeframe)
    );
...
BEGIN
    ...
    IF NOT EXISTS (SELECT 1 FROM INFORMATION_SCHEMA.COLUMNS 
                   WHERE TABLE_SCHEMA = 'dbo' 
                     AND TABLE_NAME = 'Crypto_001_DEV_01_01_Fetch_Data' 
    ...
    IF NOT EXISTS (
        ...
        WHERE tc.TABLE_SCHEMA = 'dbo'
          AND tc.TABLE_NAME = 'Crypto_001_DEV_01_01_Fetch_Data'
    ...
    BEGIN
        ...
        ADD CONSTRAINT PK_Crypto_001_Fetch_Data 
