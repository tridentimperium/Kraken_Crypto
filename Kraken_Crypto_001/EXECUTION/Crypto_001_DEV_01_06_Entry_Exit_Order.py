...
DEST_TABLE = "dbo.Crypto_001_DEV_01_06_Entry_Exit_Order"
...
# ================================
create_dest_sql = f'''
IF NOT EXISTS (SELECT * FROM INFORMATION_SCHEMA.TABLES WHERE TABLE_SCHEMA = 'dbo' AND TABLE_NAME = 'Crypto_001_DEV_01_06_Entry_Exit_Order')
BEGIN
