...
# TABLE NAMES
# ================================
LOG_TABLE = "dbo.Crypto_008_DEV_01_00_Log"
LOG_SCRIPT = "Crypto_008_DEV_00_00_Log.py"
DELETE_SCRIPT = "Crypto_008_DEV_01_11_Delete_Tables.py"

# ================================
# LIST OF SCRIPTS TO RUN IN ORDER (per configuration)
# ================================
SCRIPT_LIST = [
    "Crypto_008_DEV_01_02_Analysis.py",
    "Crypto_008_DEV_01_04_Backtest.py",
    "Crypto_008_DEV_01_06_Entry_Exit_Order.py",
    "Crypto_008_DEV_01_07_Results_Analysis.py",
    "Crypto_008_DEV_01_08_Portfolio_Balance.py",
    "Crypto_008_DEV_01_09_Portfolio_Summary.py",
]
...
def setup_sql_connection():
    sql_env_file = os.path.join(SQL_ENV_DIR, "Crypto_008_sqlserver_local.env")
    if not os.path.exists(sql_env_file):
        sql_env_file = os.path.join(SQL_ENV_DIR, "Crypto_008_sqlserver_remote.env")
    if not os.path.exists(sql_env_file):
...
def log_table_exists(cursor):
    try:
        cursor.execute(
            ...
            "WHERE TABLE_NAME = 'Crypto_008_DEV_01_00_Log' AND TABLE_SCHEMA = 'dbo'"
        )
