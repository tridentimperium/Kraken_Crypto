...
# TABLE NAMES
# ================================
SOURCE_TABLE = "dbo.Crypto_002_DEV_01_02_Analysis_Results"
BACKTEST_TABLE = "dbo.Crypto_002_DEV_01_04_Analysis_Backtest"
...
# ================================
# LOAD BACKTEST PARAMETERS FROM Crypto_002_parameters.json
# (unchanged - this file is separate and always loaded)
# ================================
parameters_file = os.path.join(CONFIG_PATH, "ZZ_PARAMETERS", "Crypto_002_parameters.json")
...
IF NOT EXISTS (SELECT * FROM INFORMATION_SCHEMA.TABLES WHERE TABLE_SCHEMA = 'dbo' AND TABLE_NAME = 'Crypto_002_DEV_01_04_Analysis_Backtest')
BEGIN
    SELECT * INTO {BACKTEST_TABLE} FROM {SOURCE_TABLE} WHERE 1 = 0;
END

IF NOT EXISTS (SELECT * FROM INFORMATION_SCHEMA.COLUMNS WHERE TABLE_SCHEMA = 'dbo' AND TABLE_NAME = 'Crypto_002_DEV_01_04_Analysis_Backtest' AND COLUMN_NAME = 'EntryExit')
    ALTER TABLE {BACKTEST_TABLE} ADD EntryExit FLOAT NULL;
IF NOT EXISTS (SELECT * FROM INFORMATION_SCHEMA.COLUMNS WHERE TABLE_SCHEMA = 'dbo' AND TABLE_NAME = 'Crypto_002_DEV_01_04_Analysis_Backtest' AND COLUMN_NAME = 'LongShort')
    ALTER TABLE {BACKTEST_TABLE} ADD LongShort NVARCHAR(20) NULL;
IF NOT EXISTS (SELECT * FROM INFORMATION_SCHEMA.COLUMNS WHERE TABLE_SCHEMA = 'dbo' AND TABLE_NAME = 'Crypto_002_DEV_01_04_Analysis_Backtest' AND COLUMN_NAME = 'StartingBalance')
    ALTER TABLE {BACKTEST_TABLE} ADD StartingBalance FLOAT NULL;
IF NOT EXISTS (SELECT * FROM INFORMATION_SCHEMA.COLUMNS WHERE TABLE_SCHEMA = 'dbo' AND TABLE_NAME = 'Crypto_002_DEV_01_04_Analysis_Backtest' AND COLUMN_NAME = 'Leverage')
    ALTER TABLE {BACKTEST_TABLE} ADD Leverage FLOAT NULL;
IF NOT EXISTS (SELECT * FROM INFORMATION_SCHEMA.COLUMNS WHERE TABLE_SCHEMA = 'dbo' AND TABLE_NAME = 'Crypto_002_DEV_01_04_Analysis_Backtest' AND COLUMN_NAME = 'Quantity')
    ALTER TABLE {BACKTEST_TABLE} ADD Quantity FLOAT NULL;
IF NOT EXISTS (SELECT * FROM INFORMATION_SCHEMA.COLUMNS WHERE TABLE_SCHEMA = 'dbo' AND TABLE_NAME = 'Crypto_002_DEV_01_04_Analysis_Backtest' AND COLUMN_NAME = 'EntryPrice')
    ALTER TABLE {BACKTEST_TABLE} ADD EntryPrice FLOAT NULL;
IF NOT EXISTS (SELECT * FROM INFORMATION_SCHEMA.COLUMNS WHERE TABLE_SCHEMA = 'dbo' AND TABLE_NAME = 'Crypto_002_DEV_01_04_Analysis_Backtest' AND COLUMN_NAME = 'EntryCost')
    ALTER TABLE {BACKTEST_TABLE} ADD EntryCost FLOAT NULL;
IF NOT EXISTS (SELECT * FROM INFORMATION_SCHEMA.COLUMNS WHERE TABLE_SCHEMA = 'dbo' AND TABLE_NAME = 'Crypto_002_DEV_01_04_Analysis_Backtest' AND COLUMN_NAME = 'ExitPrice')
    ALTER TABLE {BACKTEST_TABLE} ADD ExitPrice FLOAT NULL;
IF NOT EXISTS (SELECT * FROM INFORMATION_SCHEMA.COLUMNS WHERE TABLE_SCHEMA = 'dbo' AND TABLE_NAME = 'Crypto_002_DEV_01_04_Analysis_Backtest' AND COLUMN_NAME = 'ExitCost')
    ALTER TABLE {BACKTEST_TABLE} ADD ExitCost FLOAT NULL;
IF NOT EXISTS (SELECT * FROM INFORMATION_SCHEMA.COLUMNS WHERE TABLE_SCHEMA = 'dbo' AND TABLE_NAME = 'Crypto_002_DEV_01_04_Analysis_Backtest' AND COLUMN_NAME = 'ProfitLoss')
    ALTER TABLE {BACKTEST_TABLE} ADD ProfitLoss FLOAT NULL;
IF NOT EXISTS (SELECT * FROM INFORMATION_SCHEMA.COLUMNS WHERE TABLE_SCHEMA = 'dbo' AND TABLE_NAME = 'Crypto_002_DEV_01_04_Analysis_Backtest' AND COLUMN_NAME = 'EndingBalance')
