...
# FIXED TABLE NAMES
# ================================
FETCH_TABLE = "dbo.Crypto_002_DEV_01_01_Fetch_Data"
ANALYSIS_TABLE = "dbo.Crypto_002_DEV_01_02_Analysis_Results"
...
if len(sys.argv) > 1:
    ...
    variables_file = os.path.join(CONFIG_PATH, "ZZ_VARIABLES", "Crypto_002_variables.json")
...
# ================================
sql_env_file = os.path.join(CONFIG_PATH, "SQLSERVER", "Crypto_002_sqlserver_local.env")
if not os.path.exists(sql_env_file):
    sql_env_file = os.path.join(CONFIG_PATH, "SQLSERVER", "Crypto_002_sqlserver_remote.env")
if not os.path.exists(sql_env_file):
...
IF NOT EXISTS (SELECT * FROM INFORMATION_SCHEMA.TABLES
               WHERE TABLE_SCHEMA = 'dbo' AND TABLE_NAME = 'Crypto_002_DEV_01_02_Analysis_Results')
BEGIN
...
BEGIN
    IF EXISTS (SELECT * FROM INFORMATION_SCHEMA.COLUMNS
        ...
        EXEC sp_rename 'dbo.Crypto_002_DEV_01_02_Analysis_Results.PTPercent', 'L_PTPercent', 'COLUMN';

    IF EXISTS (SELECT * FROM INFORMATION_SCHEMA.COLUMNS
               WHERE TABLE_SCHEMA = 'dbo' AND TABLE_NAME = 'Crypto_002_DEV_01_02_Analysis_Results'
               AND COLUMN_NAME = 'SLPercent')
        EXEC sp_rename 'dbo.Crypto_002_DEV_01_02_Analysis_Results.SLPercent', 'L_SLPercent', 'COLUMN';

    IF EXISTS (SELECT * FROM INFORMATION_SCHEMA.COLUMNS
               WHERE TABLE_SCHEMA = 'dbo' AND TABLE_NAME = 'Crypto_002_DEV_01_02_Analysis_Results'
               AND COLUMN_NAME = 'PTPrice')
        EXEC sp_rename 'dbo.Crypto_002_DEV_01_02_Analysis_Results.PTPrice', 'L_PTPrice', 'COLUMN';

    IF EXISTS (SELECT * FROM INFORMATION_SCHEMA.COLUMNS
               WHERE TABLE_SCHEMA = 'dbo' AND TABLE_NAME = 'Crypto_002_DEV_01_02_Analysis_Results'
               AND COLUMN_NAME = 'SLPrice')
        EXEC sp_rename 'dbo.Crypto_002_DEV_01_02_Analysis_Results.SLPrice', 'L_SLPrice', 'COLUMN';

    IF NOT EXISTS (SELECT * FROM INFORMATION_SCHEMA.COLUMNS WHERE TABLE_SCHEMA = 'dbo' AND TABLE_NAME = 'Crypto_002_DEV_01_02_Analysis_Results' AND COLUMN_NAME = 'L_PTPercent')
        ALTER TABLE {ANALYSIS_TABLE} ADD L_PTPercent DECIMAL(10,2) NULL;
    IF NOT EXISTS (SELECT * FROM INFORMATION_SCHEMA.COLUMNS WHERE TABLE_SCHEMA = 'dbo' AND TABLE_NAME = 'Crypto_002_DEV_01_02_Analysis_Results' AND COLUMN_NAME = 'L_SLPercent')
        ALTER TABLE {ANALYSIS_TABLE} ADD L_SLPercent DECIMAL(10,2) NULL;
    IF NOT EXISTS (SELECT * FROM INFORMATION_SCHEMA.COLUMNS WHERE TABLE_SCHEMA = 'dbo' AND TABLE_NAME = 'Crypto_002_DEV_01_02_Analysis_Results' AND COLUMN_NAME = 'L_PTPrice')
        ALTER TABLE {ANALYSIS_TABLE} ADD L_PTPrice FLOAT NULL;
    IF NOT EXISTS (SELECT * FROM INFORMATION_SCHEMA.COLUMNS WHERE TABLE_SCHEMA = 'dbo' AND TABLE_NAME = 'Crypto_002_DEV_01_02_Analysis_Results' AND COLUMN_NAME = 'L_SLPrice')
        ALTER TABLE {ANALYSIS_TABLE} ADD L_SLPrice FLOAT NULL;
    IF NOT EXISTS (SELECT * FROM INFORMATION_SCHEMA.COLUMNS WHERE TABLE_SCHEMA = 'dbo' AND TABLE_NAME = 'Crypto_002_DEV_01_02_Analysis_Results' AND COLUMN_NAME = 'S_PTPercent')
        ALTER TABLE {ANALYSIS_TABLE} ADD S_PTPercent DECIMAL(10,2) NULL;
    IF NOT EXISTS (SELECT * FROM INFORMATION_SCHEMA.COLUMNS WHERE TABLE_SCHEMA = 'dbo' AND TABLE_NAME = 'Crypto_002_DEV_01_02_Analysis_Results' AND COLUMN_NAME = 'S_SLPercent')
        ALTER TABLE {ANALYSIS_TABLE} ADD S_SLPercent DECIMAL(10,2) NULL;
    IF NOT EXISTS (SELECT * FROM INFORMATION_SCHEMA.COLUMNS WHERE TABLE_SCHEMA = 'dbo' AND TABLE_NAME = 'Crypto_002_DEV_01_02_Analysis_Results' AND COLUMN_NAME = 'S_PTPrice')
        ALTER TABLE {ANALYSIS_TABLE} ADD S_PTPrice FLOAT NULL;
    IF NOT EXISTS (SELECT * FROM INFORMATION_SCHEMA.COLUMNS WHERE TABLE_SCHEMA = 'dbo' AND TABLE_NAME = 'Crypto_002_DEV_01_02_Analysis_Results' AND COLUMN_NAME = 'S_SLPrice')
        ALTER TABLE {ANALYSIS_TABLE} ADD S_SLPrice FLOAT NULL;

    IF NOT EXISTS (SELECT * FROM INFORMATION_SCHEMA.COLUMNS WHERE TABLE_SCHEMA = 'dbo' AND TABLE_NAME = 'Crypto_002_DEV_01_02_Analysis_Results' AND COLUMN_NAME = 'EntryExit')
        ALTER TABLE {ANALYSIS_TABLE} ADD EntryExit FLOAT NULL;
    IF NOT EXISTS (SELECT * FROM INFORMATION_SCHEMA.COLUMNS WHERE TABLE_SCHEMA = 'dbo' AND TABLE_NAME = 'Crypto_002_DEV_01_02_Analysis_Results' AND COLUMN_NAME = 'LongShort')
        ALTER TABLE {ANALYSIS_TABLE} ADD LongShort NVARCHAR(20) NULL;
    IF NOT EXISTS (SELECT * FROM INFORMATION_SCHEMA.COLUMNS WHERE TABLE_SCHEMA = 'dbo' AND TABLE_NAME = 'Crypto_002_DEV_01_02_Analysis_Results' AND COLUMN_NAME = 'N005')
        ALTER TABLE {ANALYSIS_TABLE} ADD N005 FLOAT NULL;
    IF NOT EXISTS (SELECT * FROM INFORMATION_SCHEMA.COLUMNS WHERE TABLE_SCHEMA = 'dbo' AND TABLE_NAME = 'Crypto_002_DEV_01_02_Analysis_Results' AND COLUMN_NAME = 'StartingBalance')
        ALTER TABLE {ANALYSIS_TABLE} ADD StartingBalance FLOAT NULL;
    IF NOT EXISTS (SELECT * FROM INFORMATION_SCHEMA.COLUMNS WHERE TABLE_SCHEMA = 'dbo' AND TABLE_NAME = 'Crypto_002_DEV_01_02_Analysis_Results' AND COLUMN_NAME = 'Leverage')
        ALTER TABLE {ANALYSIS_TABLE} ADD Leverage FLOAT NULL;
    IF NOT EXISTS (SELECT * FROM INFORMATION_SCHEMA.COLUMNS WHERE TABLE_SCHEMA = 'dbo' AND TABLE_NAME = 'Crypto_002_DEV_01_02_Analysis_Results' AND COLUMN_NAME = 'Quantity')
        ALTER TABLE {ANALYSIS_TABLE} ADD Quantity FLOAT NULL;
    IF NOT EXISTS (SELECT * FROM INFORMATION_SCHEMA.COLUMNS WHERE TABLE_SCHEMA = 'dbo' AND TABLE_NAME = 'Crypto_002_DEV_01_02_Analysis_Results' AND COLUMN_NAME = 'EntryPrice')
        ALTER TABLE {ANALYSIS_TABLE} ADD EntryPrice FLOAT NULL;
    IF NOT EXISTS (SELECT * FROM INFORMATION_SCHEMA.COLUMNS WHERE TABLE_SCHEMA = 'dbo' AND TABLE_NAME = 'Crypto_002_DEV_01_02_Analysis_Results' AND COLUMN_NAME = 'EntryCost')
        ALTER TABLE {ANALYSIS_TABLE} ADD EntryCost FLOAT NULL;
    IF NOT EXISTS (SELECT * FROM INFORMATION_SCHEMA.COLUMNS WHERE TABLE_SCHEMA = 'dbo' AND TABLE_NAME = 'Crypto_002_DEV_01_02_Analysis_Results' AND COLUMN_NAME = 'ExitPrice')
        ALTER TABLE {ANALYSIS_TABLE} ADD ExitPrice FLOAT NULL;
    IF NOT EXISTS (SELECT * FROM INFORMATION_SCHEMA.COLUMNS WHERE TABLE_SCHEMA = 'dbo' AND TABLE_NAME = 'Crypto_002_DEV_01_02_Analysis_Results' AND COLUMN_NAME = 'ExitCost')
        ALTER TABLE {ANALYSIS_TABLE} ADD ExitCost FLOAT NULL;
    IF NOT EXISTS (SELECT * FROM INFORMATION_SCHEMA.COLUMNS WHERE TABLE_SCHEMA = 'dbo' AND TABLE_NAME = 'Crypto_002_DEV_01_02_Analysis_Results' AND COLUMN_NAME = 'ProfitLoss')
        ALTER TABLE {ANALYSIS_TABLE} ADD ProfitLoss FLOAT NULL;
    IF NOT EXISTS (SELECT * FROM INFORMATION_SCHEMA.COLUMNS WHERE TABLE_SCHEMA = 'dbo' AND TABLE_NAME = 'Crypto_002_DEV_01_02_Analysis_Results' AND COLUMN_NAME = 'EndingBalance')
