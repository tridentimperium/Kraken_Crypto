...
# TABLE NAMES
# ================================
SOURCE_TABLE = "dbo.Crypto_004_DEV_01_07_Results_Analysis"
TARGET_TABLE = "dbo.Crypto_004_DEV_01_09_Portfolio_Summary"
...
if len(sys.argv) > 1:
    ...
    logger.info("Loaded config from Crypto_004_variables.json (standalone)")
...
# ================================
# LOAD PARAMETERS FROM Crypto_004_parameters.json
# ================================
...
# ================================
create_target_sql = f'''
IF NOT EXISTS (SELECT * FROM INFORMATION_SCHEMA.TABLES WHERE TABLE_SCHEMA = 'dbo' AND TABLE_NAME = 'Crypto_004_DEV_01_09_Portfolio_Summary')
BEGIN
