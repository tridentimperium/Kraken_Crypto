...
# TABLE NAMES
# ================================
SOURCE_TABLE = "dbo.Crypto_007_DEV_01_07_Results_Analysis"
TARGET_TABLE = "dbo.Crypto_007_DEV_01_09_Portfolio_Summary"
...
# ================================
# LOAD PARAMETERS FROM Crypto_007_parameters.json
# ================================
...
# ================================
create_target_sql = f'''
IF NOT EXISTS (SELECT * FROM INFORMATION_SCHEMA.TABLES WHERE TABLE_SCHEMA = 'dbo' AND TABLE_NAME = 'Crypto_007_DEV_01_09_Portfolio_Summary')
BEGIN
