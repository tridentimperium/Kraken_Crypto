...
TARGET_TABLE = "dbo.Crypto_007_DEV_01_07_Results_Analysis"
...
# ================================
create_target_sql = f'''
IF NOT EXISTS (SELECT * FROM INFORMATION_SCHEMA.TABLES WHERE TABLE_SCHEMA = 'dbo' AND TABLE_NAME = 'Crypto_007_DEV_01_07_Results_Analysis')
BEGIN
